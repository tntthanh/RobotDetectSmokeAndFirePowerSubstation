...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ros-mpu9250-ahrs/imu_filter_madgwick)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include;/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel/include;/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ros-mpu9250-ahrs/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
    _list_append_unique(imu_filter_madgwick_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "imu_filter;imu_filter_nodelet;/lib/aarch64-linux-gnu/libboost_system.so.1.71.0;/lib/aarch64-linux-gnu/libboost_thread.so.1.71.0")
